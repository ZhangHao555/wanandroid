...
public class CameraDrawer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        cameraProgram = new CameraProgram(context, R.raw.oes_base_vertex, R.raw.oes_base_fragment);

        cameraProgram.setTextureId(mTextureId);
       /* //创建滤镜.同时绑定滤镜上
        mOesFilter.create();
    ...
    private void calculateMatrix() {
        ...
        cameraProgram.setModelMatrix(mModelMatrix);
    }
