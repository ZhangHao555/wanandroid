...
class SeriesTopicFragment : BaseFragment() {
    ...
    class SeriesItemAdapter(val categoryDataLis: MutableList<CategoryItem>, fragmentManager: FragmentManager) : FragmentPagerAdapter(fragmentManager) {
        override fun getItem(position: Int): Fragment {
           return SeriesTopicFragmentItem.newInstance(categoryDataLis[position].children)
        }

        override fun getCount() = categoryDataLis.size
